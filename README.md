<h1 align='center'>API Creation - Store Manager</h1>
 <p align="center">
...
O Store Manager é um projeto desenvolvido durante o curso de formação Trybe que tem como objetivo testar conhecimentos em comandos Node e criação de uma api restful robusta e que interage com o workbench. Nesse projeto foi seguindo o fluxo de MSC com camadas para controller, model e service da api.</p>
